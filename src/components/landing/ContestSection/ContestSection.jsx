      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
        ...
        {currentContest && (
          ...
          >
            ...
            <Box
              sx={{
                height: 8,
                background: getDifficultyColor(currentContest.difficulty)
                  .gradient,
              }}
            />
              ...
              <Grid container spacing={4} alignItems="center">
                <Grid item xs={12} md={7}>
                  <Box sx={{ mb: 3 }}>
                    ...
                    >
                      ...
                      />
                      <Chip
                        label={getDifficultyLabel(currentContest.difficulty)}
                        sx={{
                          bgcolor: darkMode
                            ? `${getDifficultyColor(currentContest.difficulty).bg}20`
                            : getDifficultyColor(currentContest.difficulty).bg,
                          color: getDifficultyColor(currentContest.difficulty)
                            .text,
                          fontFamily: "Cairo, sans-serif",
                          fontWeight: 800,
                          fontSize: "0.9rem",
                      ...
                      <Grid item xs={6} sm={3}>
                        ...
                        >
                          ...
                          <Box>
                            ...
                            >
                              {formatDate(currentContest.date).split(",")[0]}
                            </Typography>
                          </Box>
                        </Box>
                      </Grid>
                        ...
                        >
                          ...
                          <Box>
                            ...
                            <Typography
                              ...
                              sx={{ color: darkMode ? "#f1f5f9" : "#1e293b" }}
                            >
                              {formatDuration(currentContest.duration)}
                            </Typography>
                          </Box>
                        </Box>
                      </Grid>
                        ...
                        >
                          ...
                          <Box>
                            ...
                            <Typography
                              ...
                              sx={{ color: darkMode ? "#f1f5f9" : "#1e293b" }}
                            >
                              {currentContest.questionCount} مسائل
                            </Typography>
                          </Box>
                        </Box>
                      </Grid>
                ...
                <Grid item xs={12} md={5}>
                  ...
                  >
                    ...
                    >
                      {getTimeUntilContest(currentContest.date)}
                    </Typography>
                    <Button
                      fullWidth
                      variant="contained"
        ...
        <Box>
          ...
          <Grid container spacing={4}>
            {Object.entries(topStudentsBySpecialization).map(
