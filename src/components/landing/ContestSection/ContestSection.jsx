...
import {
  // getCurrentContest, // ✅ CHANGED: commented out — next contest now fetched from real API.
...
// ✅ NEW: real contest API (public endpoint) + canonical stream/difficulty labels.
...
const ContestSection = () => {
  ...
  const { user } = useAuth();
  // ✅ CHANGED: fetch the next contest from the real public API (was mock getCurrentContest).
