// frontend/src/pages/auth/RegisterPage.jsx - ENHANCED WITH ALL REQUIREMENTS
...
const RegisterPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    role: "student",
    // ✅ NEW FIELDS
    division: "", // For students: "science-math", "science-bio", "arts"
    parentStudentId: "", // For parents (disabled for now)
    assistantTeacherId: "", // For assistant teachers (disabled for now)
  });
  ...
  const validateForm = () => {
    ...
    // ✅ Division validation for students
    ...
    >
      <Box sx={{ width: "100%", py: 4 }}>
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate>
          ...
          {/* ✅ PARENT STUDENT SELECTOR (DISABLED) */}
          ...
          {/* ✅ ASSISTANT TEACHER SELECTOR (DISABLED) */}
