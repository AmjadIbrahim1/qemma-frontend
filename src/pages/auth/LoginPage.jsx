// frontend/src/pages/auth/LoginPage.jsx - COMPLETE FIX
...
const LoginPage = () => {
  ...
  // ✅ NEW: Clear any existing sessions on mount
  useEffect(() => {
    const clearSessions = async () => {
      try {
        ...
        // Try to sign out from Clerk (in case there's a stale session)
        try {
          await signOut();
        } catch (e) {
  ...
  // ✅ NEW: Clear sessions before opening Clerk modal
