            ...
            <CardContent sx={{ p: 4 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                <Button
                  ...
                  variant="contained"
                  size="large"
                  startIcon={isBook ? <MenuBookRounded /> : <SchoolRounded />}
                  onClick={() => navigate(redirectPath || (isBook ? "/student/books" : "/student/courses"))}
                  sx={{
                ...
                >
                  {isBook ? "اذهب للكتاب الآن" : "ابدأ الكورس الآن"}
                </Button>
