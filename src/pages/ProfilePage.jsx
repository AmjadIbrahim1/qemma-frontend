...
import {
  ...
  School, AccountCircle, ContentCopy,
...
const ProfilePage = () => {
  ...
  const teacherSubjects = user?.teacher?.specialties?.length
                ...
                <CardContent sx={{ p: 4 }}>
                  <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" fontFamily="Cairo, sans-serif" sx={{ color: darkMode ? "#94a3b8" : "#64748b" }}>المواد المخصصة لك تلقائياً</Typography>
                    </Box>
                  </Box>
