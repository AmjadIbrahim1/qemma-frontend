                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <Person sx={{ color: darkMode ? '#94a3b8' : '#64748b' }} />
                          </InputAdornment>
                        ),
                      }}
                      InputLabelProps={{
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <Email sx={{ color: darkMode ? '#94a3b8' : '#64748b' }} />
                          </InputAdornment>
                        ),
                      }}
                      InputLabelProps={{
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <Phone sx={{ color: darkMode ? '#94a3b8' : '#64748b' }} />
                          </InputAdornment>
                        ),
                      }}
                      InputLabelProps={{
                ...
                {hasPassword ? (
                  <Paper
                    ...
                    sx={{
                      ...
                      border: '1px solid',
                      borderColor: darkMode ? 'rgba(16, 185, 129, 0.2)' : '#86efac',
                      borderRadius: 2,
                    }}
                  >
                    <Typography
                  ...
                  <Paper
                    ...
                    sx={{
                      ...
                      border: '1px solid',
                      borderColor: darkMode ? 'rgba(37, 99, 235, 0.2)' : '#bfdbfe',
                      borderRadius: 2,
                    }}
                  >
                    <Typography
                    ...
                    {!passwordMode ? (
                      ...
                      <TextField
                        ...
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position="start">
                              <Lock sx={{ color: darkMode ? '#94a3b8' : '#64748b' }} />
                            </InputAdornment>
                          ),
                          endAdornment: (
